...
public class SimpleChaincode extends ChaincodeBase {
    ...
    private Response putEntity(ChaincodeStub stub, List<String> args) throws Throwable {
    ...
    private Response getEntity(ChaincodeStub stub, List<String> args) {
        if (args.size() != 1) {
    ...
    private Response deleteEntity(ChaincodeStub stub, List<String> args) {
        if (args.size() != 1) {
            return newErrorResponse("Incorrect number of arguments. Expecting 1");
        }
        try {
